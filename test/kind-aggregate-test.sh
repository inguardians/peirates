...
# in exact 21-entry parity, and the intentionally retained manual harness must
...
echo "Kind aggregate cleanup and 21/21/21 inventory regression tests passed"
