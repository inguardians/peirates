...
# in exact 20-entry parity, and the intentionally retained manual harness must
...
echo "Kind aggregate cleanup and 20/20/20 inventory regression tests passed"
